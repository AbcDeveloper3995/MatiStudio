    ...
    <section ref={containerRef} className="relative min-h-[100dvh] w-full overflow-hidden flex flex-col justify-center items-center px-4">
      ...
      >
        ...
        >
          ...
          <span className="text-brand-orange">arte de la belleza</span>
        </motion.h1>
        ...
        >
          Cortes clásicos, arreglos de barba y tratamientos especializados en un entorno privado diseñado para tu confort y bienestar
        </motion.p>
